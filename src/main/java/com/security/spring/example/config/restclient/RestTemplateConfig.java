...
public class RestTemplateConfig {
    ...
    public RestTemplate restTemplate() {
    	...
    	RestTemplate restTemplate = new RestTemplate(requestFactory); //switching from default jdk http connection tool to apache httpclient
    	//Below is for the intercept class
